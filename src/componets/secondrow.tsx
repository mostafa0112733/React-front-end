function SecondRow() {
    const ImageUrl=[    "https://smhttp-ssl-73217.nexcesscdn.net/pub/media/wysiwyg/Black_Friday_Top_entry_points_2023/freeshipping_ar_defult.jpg",
  ...
  return (
    <>
      <div className="container">
        <div className="row">
        {ImageUrl.map((url,index)=><div key={index}className="mx-3 col-2 ">
